# BMW Alpina XB7 (2021–2025) Buyer Guide
...
*Omitted: The U.S. market Alpina XB7 is offered in a single, fully equipped configuration each year with no separate trim levels.*

## 4. Available Factory Options / Packages Offered

| Factory Option / Package | 2021–2022 Pricing / Status | 2023–2025 Pricing / Status | Notes |
|---|---|---|---|
| 21" Alpina Dynamic Wheels (All-Season) | No-cost option | No-cost option | Swaps the 23" wheels for 21" with run-flat all-seasons. Better ride quality. |
| 23" Alpina Classic Wheels (Summer) | Standard | Standard | The iconic 20-spoke Alpina wheels. Forged alloy. |
| Second-Row Captain's Chairs | Optional, $850 | Optional, $850 | Reduces seating from 7 to 6 but drastically improves second-row luxury. |
| Bowers & Wilkins Diamond Surround Sound | Optional, $3,400 | Optional, $3,400 | Massive upgrade over the standard Harman Kardon system. |
| Panoramic Sky Lounge LED Roof | Optional, $750 | Standard (LCI) | Adds LED light patterns to the panoramic glass. Standardized on later models. |
| Rear-Seat Entertainment Professional | Optional, $2,200 | Not offered | Dropped from the options list in later years. |
| Trailer Hitch | Optional, $550 | Optional, $550 | Factory tow hitch. |
| Full Merino Leather | Optional, $1,500 | Optional, $1,500 | Upgrades from Extended Merino to Full Merino (dash, lower doors). |
| Alpina Green Metallic Paint | No-cost option | No-cost option | Signature Alpina color, highly desirable but must be specially ordered. |
| Alpina Blue Metallic Paint | Standard | Standard | The other signature Alpina color. |
| Tanzanite Blue II / Ametrin / Dravit Grey | Optional, $1,950 | Optional, $1,950 | Priority 1 metallic paints. |
...
| Strongly Preferred | Second-Row Captain's Chairs | Optional, $850 | Most XB7 buyers prefer the luxury of six-passenger seating over the utility of a bench seat. |
| Spec-Dependent | 21" Alpina Dynamic Wheels | No-cost option | While the 23" wheels look incredible, they ride harsh and tires are expensive. 21" wheels are preferred by buyers who prioritize ride comfort over aesthetics. |

## 6. Common Problems / Recalls

PPI reminder: Use a BMW/Alpina specialist. Focus on complex HVAC and suspension components, not generic used-car wear.
...
| Air Suspension Faults | The heavy XB7 relies on complex two-axle air suspension. Check for sagging corners after sitting, or dashboard suspension fault warnings indicating bad modules or leaking struts. |
