# Porsche 911 Turbo S 992.1 2021-2025 Buyer Guide

The Porsche 911 Turbo S 992.1, produced from 2021 to 2025, represents the pinnacle of Porsche's performance engineering, blending supercar-level acceleration with everyday usability. As a hack candidate, its strong resale value and consistent demand make it an attractive proposition, though the primary risk lies in the potential for high maintenance costs associated with its advanced technology and specialized components.
...
|---|---|
| PDK shift fork distance sensor failure | Internal sensor housing deforms from heat cycling, causing limp mode and costing $3,850 - $10,500 |
| PCCB ceramic brake disc replacement | Ceramic discs wear out and cost approximately $6,380 - $11,660 each at dealer |
| Center-lock wheel recall (Sep-Dec 2023 production) | Stop-drive recall on center-lock equipped 992s built late 2023, costing $0 - $583 |
| Keyless entry / PADM electronics quirks | Door locks and engine mount control module problems, costing $350 - $2,100 |
| Audio system speaker failures | Speaker, insulation, or wiring failures in Burmester/BOSE systems, costing $466 - $1,750 |
| Injector failures and misfiring | TSB exists for injector failure causing misfire under load, costing $1,750 - $4,660 |

### NHTSA Recalls

| NHTSA Recall | Campaign | Affected Years | Issue |
|---|---|---|---|
| 23V715000 | N/A | 2021-2023 | AIR BAGS: Seat-mounted air bags may deploy unnecessarily during a crash (for vehicles equipped with optional full bucket seats). |
| 24V123000 | N/A | 2023 | SEAT BELTS:REAR/OTHER:RETRACTOR: Seat belt automatic locking retractor (ALR) may deactivate early, which can prevent the child restraint system from securing properly. |
