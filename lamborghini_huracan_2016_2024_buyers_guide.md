# Lamborghini Huracan Buyer's Guide: 2016-2024
...
*   **Performante Spyder:** The convertible version of the Performante (2019).
*   **EVO:** A mid-cycle refresh with updated styling, technology, and four-wheel steering (2019-2024).
*   **EVO RWD:** The rear-wheel-drive version of the EVO (2021-2024).
*   **EVO Spyder:** The convertible version of the EVO (2019-2024).
*   **STO (Super Trofeo Omologata):** A road-legal race car, highly focused on track performance (2021-2024).
*   **Tecnica:** A blend of STO performance and EVO comfort (2022-2024).
*   **Sterrato:** An off-road capable variant with raised suspension and rugged styling (2023-2024).
*   **STJ:** A limited-edition model (10 units) marking the end of the V10 Huracan production (2024).

## 4. Available Factory Options / Packages

Lamborghini provides extensive customization options for the Huracan, allowing buyers to tailor their vehicle to their exact preferences. Pricing for these options can vary by model year and specific variant. Below is a consolidated overview of notable factory options and their approximate U.S. pricing:

### 2016 Lamborghini Huracán (Partial List)

| Option Category | Option Description | Price (USD) |
|---|---|---|
| **Exterior Colors** | Metallic (e.g., Nero Helène, Blu Achelous) | $2,500 |
| | Pearl Effect (e.g., Giallo Midas, Verde Mantis) | $4,500 |
| | Matt (e.g., Nero Nemesis, Bianco Canopus) | $14,000 |
| | Ad Personam Metallic (e.g., Marrone Alcestis) | $9,900 |
| **Exterior Design** | Transparent Engine Bonnet with carbon forged engine bay | $7,000 |
| | LED engine compartment lighting | $500 |
| | Style package | $1,800 |
...
| Option Category | Option Description | Price (USD) |
|---|---|---|
| **Exterior** | Style Package | $3,400 |
| | Forged Composite Engine Bay | $4,800 |
| | Transparent Engine Bonnet | $7,000 |
| **Performance** | Carbon Ceramic Brakes with Red Calipers | $1,300 |
| | Lifting System + Magneto-rheological Suspension | $6,900 |
| | Lamborghini Telemetry System | $3,900 |
| **Interior/Tech** | Navigation System | $4,100 |
| | Bluetooth | $1,000 |
| | Rear View Camera | $3,900 |
| | Front and Rear Parking Sensors | $2,100 |
| | Full Electric and Heated Seats | $3,200 |
| | Alcantara Interior with Contrast Stitching | $2,100 |
| | Travel Package (Cupholder, Storage Box) | $1,000 |
| | Ad Personam Interior | $10,000+ |

### 2021 Lamborghini Huracan STO (Partial List)

| Option Category | Option Description | Price (USD) |
|---|---|---|
| **Exterior** | Full Exterior Carbon Pack | $12,000 |
| | STO-Livery | $10,000+ |
| | Hek 20" Forged Wheels | $6,300 |
| **Interior/Tech** | Carbon Skin Interior Pack | $6,000 |
| | Sport Seats | $7,500 |
| | Full Electric Seats | $3,200 |
| | Lifting System | $4,000 |
| | Lamborghini Telemetry System | $5,000 |
| | Rear View Camera | $3,900 |
| | Front and Rear Parking Sensors | $2,100 |
| | Travel Package | $1,000 |
...
*   **Navigation System and Rear View Camera/Parking Sensors:** For modern usability, these technology options are highly recommended. The navigation system provides convenience, while the rearview camera and parking sensors are invaluable for maneuvering a low-slung supercar in tight spaces, preventing accidental scrapes.
*   **Ad Personam Interior/Exterior Options:** While not a single option, any Ad Personam customization adds a layer of exclusivity and personalization, which can be a significant draw for future buyers, especially if tastefully executed.

## 6. Common Problems / Recalls

While the Lamborghini Huracan is generally robust, prospective buyers should be aware of certain common issues and recall campaigns:

### NHTSA Recall Campaigns

Several NHTSA (National Highway Traffic Safety Administration) recall campaigns have been issued for various Lamborghini Huracan model years. It is crucial for owners and prospective buyers to verify that all applicable recalls have been addressed. The following table summarizes the identified recalls:
...
*   **NHTSA CAMPAIGN NUMBER: 24V701 (2024 Huracan EVO Spyder)**
...
*   **NHTSA CAMPAIGN NUMBER: 21V466000 (Affects 2018-2021 Huracan models)**
    *   **Issue:** Rearview Camera Image May Not Display/FMVSS 111. A rearview camera that does not display an image reduces the driver's rear view, increasing the risk of a crash.

### Known Mechanical/Reliability Problems

While the Lamborghini Huracan is generally considered a reliable supercar, certain issues have been reported by owners:

*   **Front Lift System Failure:** Some owners, particularly of earlier models, have reported issues with the front lift system. Its failure can lead to costly repairs or undercarriage damage.
*   **Leaks and Undercarriage Damage:** Due to its low ground clearance, the Huracan is susceptible to undercarriage damage if not driven carefully. Owners should inspect for fluid leaks.
*   **Rear Lower Timing Chain Cover Leak:** One reported instance involved a 3-year-old Huracan with low mileage developing a rear lower timing chain cover leak, a significant repair often requiring an engine-out procedure.
...
Research indicates no widespread class-action lawsuits specifically targeting mechanical or reliability issues of the Lamborghini Huracan in the U.S. market.
...
The Lamborghini Huracan, across its diverse range of models from 2016 to 2024, offers an unparalleled supercar experience. Whether you prioritize the raw, naturally aspirated V10 of the original LP 610-4, the track-honed precision of the Performante, the technological sophistication of the EVO, or the extreme focus of the STO, there is a Huracan to suit nearly every enthusiast. The Sterrato even carves out a unique niche for adventurous owners.

When considering a purchase, a thorough pre-purchase inspection (PPI) by a Lamborghini specialist is paramount. Verify that all recall campaigns have been addressed and pay close attention to the condition of the front lift system, undercarriage, and any signs of fluid leaks. Opting for models with desirable factory options like carbon ceramic brakes, magneto-rheological suspension, and the transparent engine bonnet can enhance both the ownership experience and future resale value.

Ultimately, the "best" Huracan is the one that aligns with your specific driving intentions and budget. For pure driving engagement and potential collector appeal, the Performante remains a top choice. For a more modern and refined experience, the EVO variants are excellent. The LP 610-4 offers exceptional value for the quintessential V10 experience. Regardless of the chosen variant, the Lamborghini Huracan promises an exhilarating journey into the world of exotic car ownership.

## 9. Car Hacking Shortcuts

*   **Pre-Purchase Inspection (PPI) is Non-Negotiable:** Always invest in a comprehensive PPI from a reputable independent Lamborghini specialist. This will uncover potential mechanical issues, accident history, and deferred maintenance that might not be apparent otherwise.
*   **Verify Recall Completion:** Before purchase, ensure all open NHTSA recalls (e.g., 24V701, 23V826000, 22V220000, 22V081000, 21V466000) have been completed. Lamborghini dealerships can check this using the VIN.
*   **Check Front Lift System Functionality:** Test the front lift system multiple times. Repairs can be expensive, so ensure it operates smoothly and without fault codes.
*   **Inspect Undercarriage Thoroughly:** Due to the low ride height, inspect the undercarriage for scrapes, damage, or signs of fluid leaks. This can indicate careless driving or underlying issues.
*   **Review Service History:** A complete and consistent service history from authorized Lamborghini dealerships or recognized specialists is crucial. Look for evidence of regular maintenance and any major repairs.
*   **Consider Aftermarket Exhaust:** While the factory sport exhaust is great, many owners opt for aftermarket systems (e.g., Akrapovic, Novitec) to further enhance the V10's sound. Factor this into your budget if a louder exhaust is desired.
*   **Negotiate on Options:** While desirable, some options like Ad Personam customizations or less popular wheel choices might offer negotiation leverage, especially if they don't perfectly align with your preferences.
