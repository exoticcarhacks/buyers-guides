# Mercedes AMG GT, GT S, GT C 2016-2021 Buyer Guide
## Introduction
The Mercedes AMG GT, GT S, GT C 2016-2021 represents Mercedes-AMG's dedicated sports car, a potent blend of luxury and performance designed to challenge established rivals. It stands as a compelling hack candidate due to its rapid depreciation from a high MSRP, offering significant performance value on the used market. The main risk lies in the potential for high-cost repairs, particularly concerning the complex powertrain and advanced electronics, which can quickly erode any initial savings.

## Model Year Overview
| Model Year | Version/Body Style | Base MSRP | Key Details | Buyer Takeaway |
|---|---|---|---|---|
| 2016 | AMG GT | $130 | Debut model with 456 hp. | Entry point into the AMG GT lineup. |
...
|---|---|---|---|
| AMG GT | 2016-2021 | 4.0L V8 biturbo (456 hp, then 523 hp) | Base model, received power bump and standard features in 2021. |
| AMG GT S | 2016-2019 | 4.0L V8 biturbo (503 hp) | More powerful variant, often with more standard performance features than base GT. |
| AMG GT C | 2017-2021 | 4.0L V8 biturbo (550 hp) | Wider body, rear-axle steering, electronic limited-slip differential. Top-tier performance before Black Series. |
| Stealth Edition | 2021 | 4.0L V8 biturbo (523 hp) | Aesthetic package for the base AMG GT, includes unique blacked-out trim and features. |

## Factory Options
| Factory Option/Package | Pricing/Status | Notes |
|---|---|---|
| Stealth Edition Package | Optional, 2021 models | Includes tinted headlights, black chrome trim, black brake calipers, black wheels, carbon fiber roof (coupes), sport seats, diamond-quilted leather, and black interior trim. |
| Adaptive Suspension | Standard, 2021 models; Optional, earlier models | Enhances ride comfort and handling dynamics. |
| Race Driving Mode | Standard, 2021 models; Optional, earlier models | Optimizes vehicle settings for track performance. |
| Electronic Limited-Slip Differential | Standard, 2021 models; Optional, earlier models | Improves traction and handling, especially during aggressive driving. |
| Lithium-Ion Starter Battery | Standard, 2021 models | Lighter weight and improved starting performance. |
...
A thorough Pre-Purchase Inspection (PPI) by a qualified Mercedes-AMG specialist is non-negotiable.
...
|---|---|---|---|
| 21V-478 | N/A | 2016-2018 | Power train: Driveline: Driveshaft - The bonding between the carbon-fiber driveshaft and the flange may be insufficient, which could result in driveshaft separation. |
| 21V-058 | N/A | 2016-2021 | Electrical system: Software - The software design of the communication module may fail to communicate the correct vehicle location for the emergency call system (eCall) in the event of a crash. |
| 22V-365 | N/A | 2017-2022 | Electrical system: Software - An error in the communication module's SIM card software can cause a mobile network connection failure, disabling the emergency call (eCall) system. |
| 22V-042 | N/A | 2021 | Service brakes, hydraulic: Antilock/traction control/electronic limited slip: Wheel speed sensor - The wiring harness for the front wheel speed sensor may be the incorrect length, which could result in damage to the harness during certain driving conditions. |
...
* Years to buy: 2017-2021 (GT C for performance, 2021 base GT for value)
* Options to look for: AMG GT C variant, Adaptive Suspension, Electronic Limited-Slip Differential, Race Driving Mode, Stealth Edition (for aesthetics)
